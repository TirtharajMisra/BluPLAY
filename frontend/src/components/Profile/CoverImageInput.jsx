...
function CoverImageInput({ children, setCoverImage, coverImage }) {
  ...
  return (
    <div
      className=" w-full h-full mb-4 rounded-lg  text-blue-700 bg-cover bg-center bg-no-repeat items-center relative"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full flex justify-center items-center">
          ...
          {coverPic && (
            <button
              ...
              } rounded-full bg-slate-100 text-blue-500 hover:text-blue-700 p-2`}
        ...
        <div
          ...
          } absolute right-0 bottom-0 bg-white/90 text-blue-700 flex items-center gap-1 rounded-tl-md px-2 text-center font-semibold`}
        >
          Cover
